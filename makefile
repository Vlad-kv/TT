...
$(dir_2)\camlprog.exe: $(dir_2)\hw1_reduction.mli  $(dir_2)\hw1_reduction.ml  $(dir_2)\test_2.ml  $(dir_1)\camlprog.exe
	ocamlc  -I $(dir_1) -I $(dir_2)  -o $(dir_2)\hw1_reduction.cmi  -c $(dir_2)\hw1_reduction.mli
	ocamlc  -I $(dir_1) -I $(dir_2)  -o $(dir_2)\hw1_reduction.cmo  -c $(dir_2)\hw1_reduction.ml
	ocamlc  -I $(dir_1) -I $(dir_2)  -o $(dir_2)\camlprog.exe  hw1.cmo hw1_reduction.cmo $(dir_2)\test_2.ml
...
$(dir_4)\camlprog.exe: $(dir_4)\hw2_inference.mli  $(dir_4)\hw2_inference.ml  $(dir_4)\test_4.ml  $(dir_1)\camlprog.exe  $(dir_2)\camlprog.exe  $(dir_3)\camlprog.exe
	...
	ocamlc  -I $(dir_1) -I $(dir_2) -I $(dir_3) -I $(dir_4)  -o $(dir_4)\camlprog.exe  hw2_unify.cmo hw1.cmo hw1_reduction.cmo hw2_inference.cmo $(dir_4)\test_4.ml
